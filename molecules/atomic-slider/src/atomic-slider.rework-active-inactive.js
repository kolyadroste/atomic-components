...
export default class AtomicSlider extends HTMLElement {
  constructor() {
    ...
    this._activateDeactivateSlider = this._activateDeactivateSlider.bind(this);
    document.addEventListener('resize', this._activateDeactivateSlider);
  }
  ...
  connectedCallback () {
    ...
    console.log(this.hasAttribute('activateAt'));
    console.log(this.activeStates);
    if(this.hasAttribute('activateAt')){
      this.activeStates.forEach((w)=>{
  ...
  _activateDeactivateSlider(){
    console.log("bbbb");
    this.renderDeactivated();
  }
  ...
  get activeStates() {
    let conf = this.getAttribute('activateAt');
    let actConf = [];
    try{
  ...
  disconnectedCallback() {
    ...
    document.removeEventListener('resize', this._activateDeactivateSlider);
